...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/phones',
            function PhoneController_getPhones(request: any, response: any, next: any) {
            const args = {
            };
            ...
            const promise = controller.getPhones.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/phones',
            function PhoneController_createPhone(request: any, response: any, next: any) {
            const args = {
                    phone: {"in":"body","name":"phone","required":true,"ref":"Phone"},
            };
